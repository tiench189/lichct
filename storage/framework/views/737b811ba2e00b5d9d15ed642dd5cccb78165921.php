...
<?php $__env->startSection('content'); ?>
    ...
    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php echo e(Form::hidden('id', $row->id, array('id' => 'id'))); ?>

        <div>
            <div class="col-xs-12 col-md-6 bd">
                <div class="form-group ">
                    <label>Tên nhiệm vụ: <span class="required">(*)</span></label>
                    <?php echo Form::textarea('content', $row->content,
                        array('required',
                              'class'=>'form-control',
                    ...
                    <div class="row">
                        <?php $__currentLoopData = $viphuman; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-xs-12 col-md-3">
                                <?php echo Form::radio('viphuman', $v->id, ($v->id == $row->conductor) ? true : false); ?> <?php echo $v->name; ?>
                            ...
                            <?php if($p->id != 1): ?>
                                <div class="col-xs-12 col-md-4">
                                    <input type="radio" name="priority"
                                           value="<?php echo e($p->id); ?>" <?php echo e(($p->id == $row->priority)?'checked':''); ?>> <?php echo e($p->name); ?>
                    ...
                    <select id="fList" name="firtunit[]" class="form-control select-multiple ipw" multiple="multiple"
                        ...
                        <?php $__currentLoopData = $treeunit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $item->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="u|<?php echo e($c->id); ?>" <?php echo e(in_array("u|".$c->id, $dtUnitArr)?"selected":""); ?>><?php echo e($c->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="h|<?php echo e($u->id); ?>" <?php echo e(in_array("h|".$u->id, $dtUnitArr)?"selected":""); ?>><?php echo e($u->fullname); ?><?php echo e((isset($dictunit[$u->unit]))? ' - ' . $dictunit[$u->unit]:''); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="form-group form-inline">
                    ...
                    <select id="sList" name="secondunit[]" class="form-control select-multiple ipw" multiple="multiple">
                        <?php $__currentLoopData = $treeunit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $__currentLoopData = $item->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="u|<?php echo e($c->id); ?>" <?php echo e(in_array("u|".$c->id, $dtfollowArr)?"selected":""); ?>><?php echo e($c->name); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="h|<?php echo e($u->id); ?>" <?php echo e(in_array("u|".$u->id, $dtfollowArr)?"selected":""); ?>><?php echo e($u->fullname); ?><?php echo e((isset($dictunit[$u->unit]))? ' - ' . $dictunit[$u->unit]:''); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                ...
                <div class="form-group  form-inline">
                    ...
                    <?php echo Form::text('steer_time', date("d/m/y", strtotime($row->steer_time)),
                ...
                <div class="form-group  form-inline">
                    ...
                    <?php echo Form::text('deathline', (strtotime($row->deadline) != "")?date("d/m/y", strtotime($row->deadline)):'',
                        array('class'=>'form-control datepicker',
                                ...
                                <div class="row">
                                    <div class="col-md-6 col-xs-6">
                                        <input type="checkbox" name="mtype[]" class="pick-source " id="type<?php echo e($key); ?>"
                                               value=" <?php echo e($key . '|' .$s->id); ?>" <?php echo e(in_array($s->id, $steeringSourceIds) ? "checked" : ""); ?>>
                                        <?php echo e($s->name); ?>

                                    </div>
                                    <div class="col-md-6 col-xs-6">
                                        <?php echo Form::text('note[]', in_array($s->id, $steeringSourceIds) ? $steeringSourceNotes[$s->id] : "",
                ...
                <div class="modal-body">
                    <table class="table table-bordered">
                        <?php $__currentLoopData = $sourcesteering; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><input type="checkbox" name="psource" class="pick-source"
                                           value="<?php echo e($s->code); ?>" <?php echo e(in_array($s->code, explode('|', $row->source))?'checked':''); ?>>
                                </td>
                                            ...
                                            <?php $__currentLoopData = $u->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="list-group-item">
                                                    ...
                                                    <input type="checkbox" name="pfunit" class="pick-firt-unit"
                                                           value="u|<?php echo e($c->id); ?>"
                                                           parent-id="<?php echo e($u->id); ?>" <?php echo e(in_array("u|".$c->id, $dtUnitArr)?"checked":""); ?>>
                                                    <?php echo e($c->name); ?>
                            ...
                            <ul class="list-group">
                                <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-group-item">
                                        ...
                                        <input type="checkbox" name="pfunit" class="pick-firt-unit"
                                               value="h|<?php echo e($u->id); ?>" <?php echo e(in_array("h|".$u->id, $dtUnitArr)?"checked":""); ?>>
                                            ...
                                            <?php $__currentLoopData = $u->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <li class="list-group-item">
                                                    <input type="checkbox" name="psunit" class="pick-firt-unit"
                                                           value="u|<?php echo e($c->id); ?>"
                                                           parent-id="<?php echo e($u->id); ?>" <?php echo e(in_array("u|".$c->id, $dtfollowArr)?"checked":""); ?>>
                                                    <?php echo e($c->name); ?>
                            ...
                            <ul class="list-group">
                                <?php $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="list-group-item">
                                        ...
                                        <input type="checkbox" name="psunit" class="pick-firt-unit"
                                               value="h|<?php echo e($u->id); ?>" <?php echo e(in_array("h|".$u->id, $dtfollowArr)?"checked":""); ?>>
                                        <?php echo e($u->fullname); ?><?php echo e((isset($dictunit[$u->unit]))? ' - ' . $dictunit[$u->unit]:''); ?>
